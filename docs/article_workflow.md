...
| フェーズ5 | 公式情報リサーチ・評価対象サービス決定 | `phase05_research.md`, `phase05_selected_products.md` | 公式情報リサーチは並列可 |
...
flowchart TD
  ...
  F --> G[評価対象サービス決定<br/>phase05_selected_products.md]
...
flowchart TD
  ...
  D --> E[phase05_selected_products.md]
...
| 構成作成 | すべての分析・評価ファイル | `phase07_outline.md` | 直列 |
