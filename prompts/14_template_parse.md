...
`phase09_fixed_article.md`、`phase09_factcheck_report.md`、`phase09_truthcheck_report.md`、`phase05_faq_candidates.md` を確認し、問題のない本文をWordPressブロックエディタに貼り付け可能なHTML/ブロックコードへ変換してください。
...
- FAQ/Q&Aは `phase05_faq_candidates.md` の採用方針と出典要件に反していないか確認してからブロック化する
